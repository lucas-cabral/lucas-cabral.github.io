...
const siteUrl = "https://lucas-cabral.github.io";
let updatedUrl = currentUrl.replace("https://lucas-cabral.github.io", "");
...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        section: 'Redes sociais',
        handler: () => {
          window.open("mailto:%6C%63%61%62%72%61%6C.%39%38@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Redes sociais',
        handler: () => {
          window.open("https://github.com/lucas-cabral", "_blank");
        },
      },{
        id: 'social-instagram',
        title: 'Instagram',
        section: 'Redes sociais',
        handler: () => {
          window.open("https://instagram.com/luzzca", "_blank");
        },
      },{
        id: 'social-lattes',
        title: 'Lattes',
        section: 'Redes sociais',
        handler: () => {
          window.open("http://lattes.cnpq.br/8594189800256142", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Redes sociais',
        handler: () => {
          window.open("https://orcid.org/0000-0002-7613-4035", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Redes sociais',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=W0mtTV4AAAAJ", "_blank");
        },
      },{
          id: 'lang-en-us',
          title: 'en-us',
